...
<script src="lib/layui-v2.5.5/layui.js" charset="utf-8" type="text/javascript"></script>
<script src="js/lay-config.js?v=2.0.0" charset="utf-8" type="text/javascript"></script>
<script>
